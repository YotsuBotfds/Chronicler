...
pub const URBAN_FOOD_SUFFICIENCY_MULT: f32 = 0.96;
pub const URBAN_WEALTH_RESTORATION_MULT: f32 = 1.02;
pub const URBAN_MATERIAL_SATISFACTION_BONUS: f32 = 0.034;
pub const URBAN_SAFETY_SATISFACTION_PENALTY: f32 = 0.008;
